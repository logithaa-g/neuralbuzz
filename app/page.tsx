    ...
    <div className="page">
      <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
        ...
        <div style={{ display: "flex", gap: "0.5rem", justifyContent: "center", marginTop: "1rem", flexWrap: "wrap" }}>
          ...
          <span className="badge badge-danger">⚔️ Elimination</span>
        </div>
      </div>
      ...
      {view === "join" && (
        <div className="card slide-up" style={{ width: "100%", maxWidth: 440 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            {error && <p style={{ color: "var(--danger)", textAlign: "center", fontSize: "0.9rem", background: "rgba(239,68,68,0.1)", padding: "0.6rem", borderRadius: 8 }}>{error}</p>}
            ...
            <button className="btn btn-outline" style={{ width: "100%" }} onClick={() => { setView("home"); setError(""); }}>← Back</button>
          </div>
        </div>
      )}
